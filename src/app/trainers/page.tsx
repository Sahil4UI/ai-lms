    ...
    <div>
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-primary to-accent text-primary-foreground">
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center space-y-4 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <Image
              ...
              className="mx-auto aspect-video overflow-hidden rounded-xl object-cover animate-in fade-in slide-in-from-right-8 duration-700"
            />
          </div>
        </div>
      </section>
