...
const heroSlides = [
  {
    ...
    description: "Supercharge your CS journey with an AI co-pilot for every course. Personalized, interactive, and always available.",
  ...
  },
   {
    ...
    description: "From Python to Full-Stack Web Development, our curriculum is designed to make you a job-ready engineer.",
    image: "https://placehold.co/1200x800.png",
  ...
  },
  {
    ...
    description: "Join our platform as a trainer, create world-class courses, and earn revenue while shaping the next generation of tech talent.",
    image: "https://placehold.co/1200x800.png",
